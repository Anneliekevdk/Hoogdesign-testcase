...
margin-left: 10vw;">
    ...
    <div>
        <div style="
display: flex;
align-content: center;margin-top: 4rem;">
            <h2><b>Actueel</b></h2>
        </div>
        <div style="display: flex; justify-content: space-between;">
            <div class="wrapperPicture">
                <img src="assetsTestCase/beyond-meat.jpg" style="width: 37vw;
">
...
height: 6vh;">›</p>
            ...
            {{--        het andere plaatje--}}
            <div class="wrapperPicture">
                <img src="assetsTestCase/zandbergen.jpg" style="width: 37vw;
">
                <div class="textPictureDiv">
                    <p><b>Het Logo neemt Adviesburo Bureay over</b></p>
                    <p>19-01-2021</p>
...
margin-top: 14rem; position: relative">
...
justify-content: center;">
        <div class="row justify-content-md-center" style="width: 100%; padding: 0">
...
background: #2f7df4; padding-left: 10vw;
padding-right: 10vw; padding-top: 7vw">
    <div class="container" style="padding: 0;
margin: 0;
margin-right: 1vw;
margin-left: 1vw;width: 100%;">
        <div class="row">
            <div class="col">
